...
const meta: Omit<Example, "code" | "category">[] = [
  ...
  },
  {
    ...
    explanation:
      "Draw a birthday for each person with ~[n] unif_int(1,365), then has_duplicates(...) checks whether any two match. Even small groups collide more often than intuition suggests — and the whole experiment is one expression that scales to any group size.",
